...
<div class="form col-lg-4 col-lg-offset-4  col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12">
    ...
    <form class="form-horizontal" id="addform" method="post" name="add" enctype="multipart/form-data"
        ...
        <div class="form-group">
            ...
            <div class="col-xs-9">
                <input type="text" class="form-control" id="title" name="title"
                       data-parsley-length="[1,200]" data-parsley-required value="${title}">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-9">
                <input type="text" class="form-control" id="artist" name="artist"
                       data-parsley-length="[1,200]" data-parsley-required value="${artist}">
            </div>
        </div>
        <div class="form-group">
        ...
        <input type="file" accept="audio/*" name="upfile" data-parsley-required>
        <br/>
        <div class="form-group">
