        ...
        <div class="form-group">
            ...
            <div class="col-lg-6">
                <a href="${pageContext.request.contextPath}/controller?command=account&change=login_change">
                    <button type="submit" id="lastname" class="btn btn-primary btn-sm"><fmt:message
        ...
        <div class="form-group">
            ...
            <div class="col-lg-6">
                <a href="${pageContext.request.contextPath}/controller?command=account&change=email_change">
                    <button type="submit" id="email" class="btn btn-primary  btn-sm"><fmt:message
                            key="account.button.change"/></button>
                </a>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-lg-6">
                <a href="${pageContext.request.contextPath}/controller?command=account&change=card_change">
                    <button type="submit" id="card" class="btn btn-primary btn-sm"><fmt:message
                            key="account.button.change"/></button>
                </a>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-lg-6">
                <a href="${pageContext.request.contextPath}/controller?command=account&change=password_change">
                    <button type="submit" id="password" class="btn btn-primary btn-sm"><fmt:message
                            key="account.button.change"/></button>
                </a>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-lg-6">
                <a href="${pageContext.request.contextPath}/controller?command=account&change=money_change">
                    <button type="submit" id="money" class="btn btn-default btn-sm"><fmt:message
