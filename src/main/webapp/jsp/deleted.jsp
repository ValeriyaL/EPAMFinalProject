...
<head>
    ...
    <title><fmt:message key="deleted.title"/></title>
    <!-- Bootstrap -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="col-xs-2 right">
                                    <a href="${pageContext.request.contextPath}/controller?command=recover_track&track=${tempTrack.id}" class="btn btn-primary btn-lg" style="margin: 2px"><span
                                            class="glyphicon glyphicon-shopping-cart"></span> <fmt:message
                                            key="tracks.order.recover"/></a>
                                </div>
                            </div>
                        </div>
                        <hr>
